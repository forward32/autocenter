...
void Widget::on_btn_info_clicked()
{
    QMessageBox::information(this, "Справка", "Программа представляет собой автоматизированную систему управления внутренними"
                             " делами автосалона. Данные, хранящиеся в базе данных, с которой работает приложение, хранятся на "
                             "английском языке. В дальнейшей версии продукта это будет доработано и улучшено.");
}
