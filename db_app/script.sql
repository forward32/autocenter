...
CREATE TABLE data_enter (login VARCHAR(20) NOT NULL, password VARCHAR(40) NOT NULL, post VARCHAR(20) NOT NULL, name VARCHAR (20) NOT NULL, surname VARCHAR(20) NOT NULL); 
...
not null, id_info int not null);

	# Таблица заказов запчастей
create table detail_orders (id int primary key auto_increment, data varchar(11) not null, client_name varchar(20) not null, client_otch varchar(20) not null, client_surname varchar(20) not null, id_info int not null, pre_price int, foreign key(id_info) references details_info(id));
