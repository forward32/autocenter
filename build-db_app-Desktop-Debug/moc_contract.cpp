...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_contract_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 25)
    ...
    "contract\0on_btn_exit_clicked\0\0"
    "on_btn_docontract_clicked\0"
};
...
void contract::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btn_docontract_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject contract::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_contract.data,
      qt_meta_data_contract,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_contract.stringdata))
