...
#include "../../Study/Project/db_app/statistic.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_statistic_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 102, 18)
    ...
    "statistic\0on_btn_exit_clicked\0\0"
    "on_btn_search_clicked\0on_stat_tbl_clicked\0"
    "index\0on_btn_all_cat_clicked\0"
...
void statistic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_stat_tbl_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 3: _t->on_btn_all_cat_clicked(); break;
...
const QMetaObject statistic::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_statistic.data,
      qt_meta_data_statistic,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_statistic.stringdata))
